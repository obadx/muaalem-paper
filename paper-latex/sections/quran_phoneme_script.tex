...
Example: Table~\ref{tab:examples_with_sifat} illustrates the phonetization of the word (\arb{أَتُحَٰٓجُّوٓنِّى}) row by row. The first row shows the conversion of (\arb{أَ}) to (ءَ) with its sifat attributes. The fourth row shows Madd Lazem with 6 beats represented as six alifs (\arb{اااااا}); the sixth row shows damma‑based Madd as six waw\_madd symbols (\arb{ۥۥۥۥۥۥ}). In the fifth row, (\arb{جُّ}) is converted to (\arb{ججُ}) by disassembling the shadda. The last row shows normal Madd of yaa with two beats represented as two yaa\_madd symbols (\arb{ۦۦ}).
...
\begin{table*}[h]
\centering
\caption{Examples of Uthmani to Phonetic Script Conversion with Sifat Attributes. This example illustrates the phonetization of the word (\arb{أَتُحَٰٓجُّوٓنِّى}) row by row: the first row converts (\arb{أَ}) to (ءَ) with its sifat. The fourth row shows Madd Lazem (6 beats) as six alifs (\arb{اااااا}), and the sixth row shows Madd with damma as six waw\_madd symbols (\arb{ۥۥۥۥۥۥ}). In the fifth row, (\arb{جُّ}) becomes (\arb{ججُ}) by disassembling shadda. The last row shows normal Madd of yaa as two yaa\_madd symbols (\arb{ۦۦ}).}
