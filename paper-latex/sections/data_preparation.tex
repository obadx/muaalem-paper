...
We fine-tuned Wav2Vec2-BERT for frame classification for 1 epoch using the AdamW optimizer with default betas and bfloat16 precision on an Nvidia L40 GPU, with a batch size of 50 and a maximum speech sample length of 20 seconds.
