...
The benchmark has many limitations: the size is very limited with imbalanced gender. Along with not all Tajweed rules covered like (Tasheel). Neither all phonemes like letter thaal: ذ. But it is a move towards benchmarking Tajweed rules.
