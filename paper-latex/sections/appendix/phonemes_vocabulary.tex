...
\begin{table*}[t]
	...
	\begin{tabular}{>{\raggedright}p{0.7\linewidth}c}
		\toprule
...
\begin{table*}[t]
	...
	\label{tab:sifat_set}
	\begin{tabularx}{\linewidth}{@{}>{\raggedright}p{0.22\linewidth}>{\centering\arraybackslash}p{0.18\linewidth}>{\raggedright}p{0.27\linewidth}>{\centering\arraybackslash}p{0.23\linewidth}@{}}
		\toprule
		...
		tafkheem\_or\_taqeeq     & \arb{التفخيم أو الترقيق} & mofakham, moraqaq, low\_mofakham                       & \arb{مفخم, مرقق, أدنى المفخم}                       \\
