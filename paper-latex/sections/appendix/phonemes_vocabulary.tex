...
\begin{table}[htbp]
	\centering
	\small
	\begin{tabular}{>{\raggedright}p{0.6\linewidth}c}
		\toprule
...
\begin{table}[htbp]
	...
	\begin{tabular}{p{3.2cm}p{3.8cm}}
		...
		tafkheem\_or\_taqeeq (\arb{التفخيم أو الترقيق}) & mofakham / moraqaq / low\_mofakham (\arb{مفخم, مرقق, أدنى}) \\
