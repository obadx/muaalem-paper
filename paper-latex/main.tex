...
% % % Minimal package set for Arabic support
% % \usepackage{fontspec}
% % \setmainfont{Times New Roman} % English font
% % \newfontfamily\arabicfont[Script=Arabic]{Amiri} % Arabic font
% % Custom Arabic command
% % \newcommand{\arb}[1]{%
% %     \bgroup\arabicfont #1\egroup%
% % }


% % Load essential math packages FIRST
% \usepackage{amsmath,amssymb,amsfonts}
% \usepackage{algorithmic}

% % Then load other English-support packages
% \usepackage{cite}
% \usepackage{graphicx}
% \usepackage{textcomp}
% \usepackage{xcolor}
...
% % Now load bidirectional text support
% \usepackage{polyglossia}
% \setdefaultlanguage{english}
% \setotherlanguage{arabic}
% \newfontfamily\arabicfont[Script=Arabic]{Amiri}

% % Define \arb command safely
% \newcommand{\arb}[1]{\textarabic{#1}}

% % Load hyperref LAST (with configuration)
% \usepackage{hyperref}
% \hypersetup{
%     colorlinks=true,
%     linkcolor=blue,
...
\scriptsize
Phonetization of word (\hafs{أَتُحَٰٓجُّوٓنِّى}) \\
