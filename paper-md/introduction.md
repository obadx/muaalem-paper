...
Since 2006, numerous studies have proposed computer-aided pronunciation learning systems for the Quran like RDI [sherif2007enhancing]. However, these works remain irreproducible due to undisclosed code and data, forcing each new research effort to restart from fundamental definitions of phoneticization, datasets, and models. Although recent efforts like [abdelfattah2025automatic] have introduced a benchmark in Modern Standard Arabic (MS) reciting the Holy Quran, it lacks the inclusion of Tajweed rules. To address this systemic gap, we introduce:
...
Most importantly, we release inference code, phoneticization tools, datasets, and models to enable reproducible research.
